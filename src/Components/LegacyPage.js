    ...
    <>
        ...
        <div className='legacyDiv1 flex w-full'>
            <div className='w-[50%] relative'>
                ...
                <div className='z-50 text-5xl absolute top-8 md:top-24 font-bold font-zodiac right-6 text-white'>1967</div>
            </div>
        ...
        <div className='legacyDiv2 flex w-full text-right'>
            <div className='w-1/2 bg-white flex pr-8 py-8 md:py-24'>
                <div className='my-auto items-end'>
                    <p className='text-xl md:text-3xl text-[#0B6476] font-bold font-zodiac'>Automobile Sector</p>
                    <p className='text-[#0B6476] my-6 font-outfit opacity-65 text-xs md:text-sm ml-[24%]'>After textiles, in 2008, the group was presented with an opportunity to establish a Bajaj two-wheeler dealership in Baramati. Building on this experience, they expanded with a Hyundai dealership in 2011, a Chetak dealership in 2021, and a TATA-authorized service station. Today, the Somani Group operates over 15 locations under their automobile dealership portfolio, showcasing their commitment to quality service and customer satisfaction.</p>
            ...
            <div className='w-[50%] relative'>
                ...
                <div className='z-50 text-5xl absolute top-8 md:top-24 font-bold font-zodiac left-6 text-[#0B6476]'>2008</div>
            </div>
        </div>
        ...
        <div className='legacyDiv4 flex w-full text-right'>
            ...
            <div className='w-[50%] relative'>
                ...
                <div className='z-50 text-5xl absolute top-8 md:top-24 font-bold font-zodiac left-6 text-[#0B6476]'>2015</div>
            </div>
        </div>
        <div className='legacyDiv5 flex w-full'>
            ...
            <div className='w-1/2 bg-[#0B6476] flex justify-start p-8 py-8 md:py-24'>
                <div className='my-auto'>
                    <p className='text-xl md:text-3xl text-white font-bold font-zodiac'>Real Estate</p>
                    <p className='text-white w-3/4 my-6 font-outfit opacity-65 text-xs md:text-sm'>The group ventured into real estate three years ago, establishing projects in Pune and Baramati. With a focus on quality and timely delivery, they aim to be a trusted name in real estate.</p>
                    <p className='flex cursor-pointer'><p className='text-white font-outfit text-sm'>Learn More</p><img src={arrow} alt="" /> </p>
                </div>
            </div> 
        </div>
